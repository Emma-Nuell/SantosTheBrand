...
const NavLink: FC<NavLinkProps> = ({ to, children }) => (
  <Link
    to={to}
    className="text-sm font-medium text-slate-800 hover:text-primary-600 tracking-widest uppercase transition-colors relative group"
  >
    {children}
...
const MobileNavLink: FC<MobileNavLinkProps> = ({ to, children, onClick }) => (
  <Link
    to={to}
    onClick={onClick}
...
try {
  const response =  subscribe.mutateAsync(email)
      ...
      <div className="min-h-screen flex flex-col bg-white text-slate-900 selection:bg-primary-200 selection:text-primary-900 relative">
        ...
        >
          <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-3 items-center">
            ...
            <div className="flex items-center justify-end space-x-6">
              ...
              <Link
                to="/wishlist"
                className="text-slate-800 hover:text-primary-600 transition-colors relative hidden sm:block"
              >
              ...
              <Link
                to="/cart"
                className="text-slate-800 hover:text-primary-600 transition-colors relative"
              >
                  ...
                  <AnimatePresence>
                    {isUserMenuOpen && (
                      ...
                      >
                        ...
                        <Link
                          to="/dashboard"
                          className="block px-4 py-2 text-sm hover:bg-gray-50 text-slate-700"
                        >
                          Dashboard
                        </Link>
                        <Link
              ...
              >
                ...
                <div className="mt-auto pt-8 border-t border-gray-100">
                  {user ? (
                    ...
                    <Link
                      to="/auth"
                      className="block w-full py-4 bg-primary-950 text-white text-center uppercase tracking-widest text-sm font-medium hover:bg-primary-900"
                    >
                      Sign In
                    </Link>
                  )}
        ...
        <footer className="bg-white border-t border-gray-100 text-slate-900 pt-20 pb-12">
          <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              <h4 className="font-bold text-xs uppercase tracking-widest mb-6 text-slate-400">
                Discovery
              </h4>
