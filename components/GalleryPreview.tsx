...
const GalleryPreview = (galleryProducts: any) => {
  return (
    <section id="gallery" className="py-24 bg-primary-50">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div className="max-w-xl">
            <h2 className="font-serif text-4xl md:text-5xl text-primary-950 mb-6">
              The Santos Aesthetic
            </h2>
            <p className="text-slate-500 font-light leading-relaxed">
              A curated visual journey through our latest campaign. Where
              texture meets silhouette in perfect harmony.
            </p>
          </div>
          <Link
            to="/gallery"
            className="hidden md:block text-sm font-bold uppercase tracking-widest border-b border-primary-950 pb-1 hover:text-primary-600 hover:border-primary-600 transition-colors"
          >
            View Full Gallery
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 h-auto md:h-[600px]">
          ...
          >
            <img
              src={galleryProducts[2].src}
              alt={galleryProducts[2].title}
          ...
          <div className="flex flex-col gap-6 lg:col-span-1">
            ...
            >
              <img
                src={galleryProducts[3].src}
                alt={galleryProducts[3].title}
                className="w-full h-full object-cover transition-transform duration-1000 ease-luxury group-hover:scale-110"
              />
            </motion.div>
          </div>
          ...
          >
            <img
              src={galleryProducts[1].src}
              alt={galleryProducts[1].title}
              className="w-full h-full object-cover transition-transform duration-1000 ease-luxury group-hover:scale-110"
            />
          </motion.div>
        </div>
        ...
        <Link
          to="/gallery"
          className="md:hidden mt-8 block w-full text-center text-sm font-bold uppercase tracking-widest border border-primary-950 py-3 hover:bg-primary-950 hover:text-white transition-colors"
        >
          View Full Gallery
        </Link>
      </div>
